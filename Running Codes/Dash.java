    ...
    private void initialize() {
        ...
        btnComplaint.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Launch the ReportPage when clicked
                EventQueue.invokeLater(new Runnable() {
                    public void run() {
                        try {
                            ReportPage reportPage = new ReportPage(); // Initialize the ReportPage
                            reportPage.frame.setVisible(true); // Open the ReportPage frame
                        } catch (Exception ex) {
                            ex.printStackTrace();
                        }
                    }
...
//        JButton btnProduct = new JButton("PRODUCT");
        ...
        btnProduct.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Instantiate and show the ProductPage
                ProductPage productPage = new ProductPage();
                productPage.frame.setVisible(true);
            }
        });

        btnProduct.setFont(new Font("Tahoma", Font.BOLD, 15));
        btnProduct.setBounds(259, 563, 147, 51); // Adjust positioning as needed
        ...
        btnAdd.addActionListener(e -> {
            ...
            productPage.main(null); // Call the main method to display the frame
        });
//        panel_2.add(btnAdd);
